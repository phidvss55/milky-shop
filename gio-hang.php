...
<div class="col-md-9 bor">
    <section class="box-main1">
        ...
        <?php endif ?>
        <table class="table table-hover login-name" id="shoppingcart_info">
            <thead>
                <tr>
                    <th>STT</th>
                    <th>Tên sản phẩm</th>
            ...
            <tbody>
                <?php $stt = 1; foreach ($_SESSION['cart'] as $key => $value): ?>
                    <tr>
                        ...
                        <td>
                            <img src="<?php echo uploads() ?>product/<?php echo $value['thunbar'] ?>" width="80px" height="130px">
                        </td>
                        <td>
        ...
        <div class="col-md-5 pull-right">
            <ul class="list-group">
                ...
                <li class="list-group-item">
                    <span class="badge"> 
                        <!-- tong tien ow file gio hang, total o file thanh toan -->
                ...
                <li class="list-group-item">
                    ...
                    <a href="thanh-toan.php" class="btn btn-success col-md-offset-2">Thanh toán</a>
                </li>
