...
$hours = array(
    'mon' => array('07:00-21:00'),
    'tue' => array('07:00-21:00'),
    'wed' => array('07:00-21:00'),
    'thu' => array('07:00-21:00'),
    'fri' => array('07:00-20:00'),
    'sat' => array('08:00-17:00'),
...
$open_now = "<strong class='open'>Xin chào, chúng tôi đang mở cửa! Hôm nay từ %open% đến %closed%.</strong>";
$closed_now = "<strong class='closed'>Xin lỗi, chúng tôi đang đóng cửa! Hôm nay từ %open% đến %closed%.</strong>";
$closed_all_day = "<strong class='closed'>Xin lỗi, Chúng tôi đóng cửa vào %day%.</strong>";
$exception = "<strong class='closed'>Xin lỗi, nhân dịp %exception% chúng tôi xin đóng cửa.</strong>";
